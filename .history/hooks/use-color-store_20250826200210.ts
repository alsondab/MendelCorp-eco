...
export default function useColorStore(theme: string = 'light') {
  ...
  const cssColors: { [key: string]: string } = {
    '--primary':
      theme === 'light' ? color.root['--primary'] : color.dark['--primary'],
    '--primary-foreground':
      theme === 'light'
        ? color.root['--primary-foreground']
        : color.dark['--primary-foreground'],
    '--accent':
      theme === 'light' ? color.root['--accent'] : color.dark['--accent'],
    '--accent-foreground':
      theme === 'light'
        ? color.root['--accent-foreground']
