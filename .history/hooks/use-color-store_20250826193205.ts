...
export default function useColorStore(theme: string = 'light') {
  ...
  return {
    ...
    updateCssVariables: () => {
      ...
      // Debug log
      console.log('Applying colors:', { theme, colorName: color.name, colors })
      ...
      // Forcer le re-render
      document.documentElement.classList.add('color-updated')
      setTimeout(() => {
        document.documentElement.classList.remove('color-updated')
      }, 100)
    },
  }
}
