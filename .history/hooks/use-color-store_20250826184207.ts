...
export default function useColorStore(theme: string = 'light') {
  ...
  return {
    ...
    setColor: (name: string, isUserColor?: boolean) => {
      console.log('Setting color:', name, 'isUserColor:', isUserColor)
      colorStore.setState(
    ...
    updateCssVariables: () => {
      ...
      const colors: { [key: string]: string } =
        theme === 'light' ? currentColor.root : currentColor.dark
      
      console.log('Updating CSS variables for theme:', theme, 'color:', currentColor.name)
