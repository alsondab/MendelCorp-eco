...
export default function useColorStore(theme: string = 'light') {
  ...
  // Ne plus redéfinir les variables CSS de base, juste les couleurs personnalisées
  const cssColors: { [key: string]: string } = {
    '--primary': theme === 'light' ? color.root['--primary'] : color.dark['--primary'],
    '--primary-foreground': theme === 'light' ? color.root['--primary-foreground'] : color.dark['--primary-foreground'],
    '--accent': theme === 'light' ? color.root['--accent'] : color.dark['--accent'],
    '--accent-foreground': theme === 'light' ? color.root['--accent-foreground'] : color.dark['--accent-foreground'],
    '--ring': theme === 'light' ? color.root['--ring'] : color.dark['--ring'],
    // Gardez seulement les couleurs qui ne sont pas dans next-themes
  }
  ...
  return {
    ...
    updateCssVariables: () => {
      const color = getColor()
      // Appliquer seulement les couleurs personnalisées, pas toutes les variables
