...
const products: IProductInput[] = [
    // Caméras de surveillance
    {
      ...
      images: ['/images/camera1-1.jpg', '/images/camera1-2.jpg'],
      ...
      specifications: ['4MP Resolution', 'Night Vision', 'Motion Detection', 'IP67 Waterproof'],
    ...
    },
    {
      ...
      category: 'Video Surveillance',
      images: [
        '/images/camera2-1.jpg',
        '/images/camera2-2.jpg',
        '/images/camera2-3.jpg',
        '/images/camera2-4.jpg',
      ],
      ...
      specifications: ['2MP Resolution', 'Night Vision 30m', 'Smart Motion Detection', 'IP67 Waterproof'],
    ...
    },
    {
      ...
      specifications: ['24" Display', 'Full HD 1920x1080', '5ms Response Time', 'VGA/HDMI Ports'],
