...
export default function TestEmailPage() {
  const [emailData, setEmailData] = useState({
    ...
    message:
      "Ceci est un email de test pour vérifier que le système d'emails fonctionne correctement.",
    userName: '',
    htmlContent:
      '<h1>Mon email HTML personnalisé</h1><p>Contenu personnalisé de test</p>',
  })
    ...
    <div className='container mx-auto p-6 max-w-4xl'>
      <div className='mb-8'>
        ...
        <p className='text-center text-gray-600'>
          Testez l'envoi d'emails vers n'importe quelle adresse pour vérifier
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm'>
            ...
            <div>
              ...
              <ul className='space-y-1'>
                <li>
                  • <code>test</code> - Email simple
                </li>
                <li>
                  • <code>welcome</code> - Email de bienvenue
                </li>
                <li>
                  • <code>custom</code> - Email HTML personnalisé
                </li>
              </ul>
            </div>
            <div>
