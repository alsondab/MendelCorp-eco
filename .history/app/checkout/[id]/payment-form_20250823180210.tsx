          ...
          <div className='space-y-2'>
            ...
            {!isPaid && (
              <div className='pt-4 space-y-3'>
                ...
                {['Orange Money', 'MTN Mobile Money', 'Moov Money'].includes(paymentMethod) && (
                  <Button
            ...
            <div className='grid md:grid-cols-3 my-3 pb-3'>
              ...
              <div className='col-span-2'>
                ...
                <p className='text-sm text-gray-600 mt-1'>
                  ...
                  {paymentMethod === 'Stripe' && 'Paiement par carte bancaire via Stripe'}
                  {['Orange Money', 'MTN Mobile Money', 'Moov Money'].includes(paymentMethod) && 
                    'Paiement mobile sécurisé'}
                  {paymentMethod === 'Cash On Delivery' && 'Paiement à la livraison'}
                </p>
              </div>
            </div>
          </div>
              ...
              <ul className='mt-2 space-y-1'>
                {items.map((item) => (
                  <li key={item.slug} className='flex justify-between'>
                    ...
                    <span><ProductPrice price={item.price} plain /></span>
                  </li>
                ))}
              </ul>
            </div>
